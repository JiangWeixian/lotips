...
exports.usePage = function (_a) {
    var _b = _a.limit, limit = _b === void 0 ? 10 : _b, _c = _a.defaultFilter, defaultFilter = _c === void 0 ? undefined : _c, _d = _a.state2Query, state2Query = _d === void 0 ? defaultState2Query : _d, _e = _a.dataKey, dataKey = _e === void 0 ? 'id' : _e, props = tslib_1.__rest(_a, ["limit", "defaultFilter", "state2Query", "dataKey"]);
    var _f = use_rematch_reducer_1.useRematchReducer({
        ...
        reducers: {
            setData: function (state, payload) {
                var _a, _b;
                return tslib_1.__assign(tslib_1.__assign({}, state), { total: (_a = payload.total, (_a !== null && _a !== void 0 ? _a : 0)), ids: payload.data.map(function (v) { return v[dataKey]; }), entries: lodash_keyby_1.default(payload.data, dataKey), pages: (_b = payload.total, (_b !== null && _b !== void 0 ? _b : 0)) / state.limit, data: payload.data });
            },
            ...
            toggleSelect: function (state, payload) {
                return tslib_1.__assign(tslib_1.__assign({}, state), { selected: lodash_xor_1.default(state.selected, payload) });
            },
                ...
                return tslib_1.__awaiter(this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 1:
                                _d.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, ((_b = (_a = props).api) === null || _b === void 0 ? void 0 : _b.call(_a, state2Query(state)))];
                            case 2:
                                _c = _d.sent(), data = _c.data, total = _c.total;
                                this.setStatus('loaded');
                                this.setData({ data: lodash_uniqby_1.default(state.data.concat(data), dataKey), total: total });
                                return [3 /*break*/, 4];
                            case 3:
                                e_1 = _d.sent();
    ...
    var handleSetFilter = react_1.useCallback(function (filter) {
    ...
    var handleSetFilterByField = react_1.useCallback(function (filed, value) {
        var _a;
        var next = tslib_1.__assign(tslib_1.__assign({}, state.filter), (_a = {}, _a[filed] = value, _a));
        dispatch.setFilter(next);
        refresh.current();
    }, [dispatch.setFilter, state.filter, dispatch.handleRefresh]);
    var handleResetFilter = react_1.useCallback(function () {
        dispatch.setFilter(defaultFilter);
        refresh.current();
    }, [dispatch.setFilter, defaultFilter, dispatch.handleRefresh]);
    var handleClearFilter = react_1.useCallback(function () {
        dispatch.clearFilter();
        refresh.current();
    }, [dispatch.setFilter, dispatch.handleRefresh]);
    return {
        state: state,
        dispatch: tslib_1.__assign(tslib_1.__assign({}, dispatch), { handleSetFilter: handleSetFilter,
