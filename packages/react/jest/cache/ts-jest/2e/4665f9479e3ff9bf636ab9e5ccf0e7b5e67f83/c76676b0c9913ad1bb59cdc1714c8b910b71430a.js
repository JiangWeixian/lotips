...
var _useAsyncState = function (nullstate) {
    if (nullstate === void 0) { nullstate = undefined; }
    var value = react_1.useContext(AsyncStateContext);
    var _a = use_async_state_1.useAsyncState(value, { nullstate: nullstate }), state = _a[0], set = _a[1];
    return {
        state: state,
        set: set,
    };
...
describe('use-async-state', function () {
    test('should be inited by async value', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var hook;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    hook = react_hooks_1.renderHook(function () { return _useAsyncState(); }, { wrapper: AsyncStateProvider });
    ...
    test('initial async value should be rewrited by manual set', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var hook;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test('nullstate value availabled be configed', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var hook;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    hook = react_hooks_1.renderHook(function () { return _useAsyncState(0); }, { wrapper: AsyncStateProvider });
                    return [4 /*yield*/, hook.waitForNextUpdate()];
                case 1:
                    _a.sent();
                    expect(hook.result.current.state).toBe(2);
