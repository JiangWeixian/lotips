...
exports.useDebounce = function (_a) {
    var interval = _a.interval, props = tslib_1.__rest(_a, ["interval"]);
    var _b = react_1.useState(props.defaultValue), value = _b[0], setValue = _b[1];
    var _c = react_1.useState(props.defaultValue), debouncedValue = _c[0], setDebouncedValue = _c[1];
