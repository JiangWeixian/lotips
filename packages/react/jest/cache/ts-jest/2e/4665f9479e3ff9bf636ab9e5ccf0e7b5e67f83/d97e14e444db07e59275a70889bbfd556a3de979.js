...
describe('use-async-effect', function() {
  test('work with async function', function() {
          ...
          case 0:
            ...
            AsyncEffectProvider = function(_a) {
              ...
              var _b = react_1.useState(1),
                value = _b[0],
                setValue = _b[1]
              use_async_effect_1.useAsyncEffect(function() {
                return tslib_1.__awaiter(void 0, void 0, void 0, function() {
                  return tslib_1.__generator(this, function(_a) {
                    switch (_a.label) {
                      case 0:
            ...
            hook = react_hooks_1.renderHook(
              function() {
                return _useAsyncEffect()
              },
              { wrapper: AsyncEffectProvider },
            )
  ...
  test('clear function shoud work fine', function() {
    return tslib_1.__awaiter(void 0, void 0, void 0, function() {
      ...
      return tslib_1.__generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            unmount = react_hooks_1.renderHook(function() {
              return _useAsyncEffect()
            }).unmount
