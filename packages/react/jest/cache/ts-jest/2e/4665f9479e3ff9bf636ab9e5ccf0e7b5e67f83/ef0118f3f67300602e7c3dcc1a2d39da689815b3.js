...
describe('use-batch', function() {
  test('combined into a batch request', function() {
    return tslib_1.__awaiter(void 0, void 0, void 0, function() {
      var hook1, hook2, hook3, hook4, hook5
      return tslib_1.__generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            hook1 = react_hooks_1.renderHook(function() {
              return use_batch_1.useBatch('use-batch', '1', api)
            })
            hook2 = react_hooks_1.renderHook(function() {
              return use_batch_1.useBatch('use-batch', '1', api)
            })
            hook3 = react_hooks_1.renderHook(function() {
              return use_batch_1.useBatch('use-batch', '1', api)
            })
            hook4 = react_hooks_1.renderHook(function() {
              return use_batch_1.useBatch('use-batch', '1', api)
            })
            hook5 = react_hooks_1.renderHook(function() {
              return use_batch_1.useBatch('use-batch', '1', api)
            })
