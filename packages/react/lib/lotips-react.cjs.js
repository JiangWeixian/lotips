...
var useAsyncState = function (value, _a) {
    ...
    var _c = React.useState(nullstate), state = _c[0], set = _c[1];
...
function useClickOutside(ref, _a) {
    ...
    var isSwitchToTouchMode = core.isMobile();
...
var useDebounce = function (_a) {
    ...
    var _b = React.useState(props.defaultValue), value = _b[0], setValue = _b[1];
    var _c = React.useState(props.defaultValue), debouncedValue = _c[0], setDebouncedValue = _c[1];
    React.useEffect(function () {
...
var useBatch = function (type, id, api) {
    var _a = React.useState(), item = _a[0], setItem = _a[1];
    React.useEffect(function () {
        if (!id)
            return;
...
var useWindowResize = function () {
    var _a = React.useState(false), resizeing = _a[0], setResizing = _a[1];
    React.useEffect(function () {
...
exports.getComponentsNotOfA = getComponentsNotOfA;
exports.getComponentsOfA = getComponentsOfA;
exports.hasComponentOfA = hasComponentOfA;
